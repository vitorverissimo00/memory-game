...
import { List, ListItem, Section, SectionsContainer, Subtitle, Text, Title } from './styles'

const GameInstructions: React.FC = () => (
  <>
    <Title>Welcome to Memory Game! 🎮</Title>
      <Text>
        Get ready to challenge your memory and reasoning skills with a dynamic
        and fun experience! Here’s everything you need to know before you start:
      </Text>
      ...
      <SectionsContainer>
        <Section>
          ...
          <Text>
            <strong>Tip:</strong> In advanced levels, cards shuffle
        ...
        <Section>
          ...
          <List>
            ...
            <ListItem>
              Penalties: Each wrong attempt reduces your score.
            </ListItem>
          </List>
          ...
          <List>
            ...
            <ListItem>
              🔄 Automatic Shuffle: In higher levels, cards shuffle again after
              10 seconds.
            </ListItem>
            <ListItem>
              🏆 Global Ranking: Compete with your friends and players
              worldwide.
            </ListItem>
          </List>
        </Section>
